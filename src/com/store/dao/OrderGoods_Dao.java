...
public class OrderGoods_Dao {
	...
	public void insert_ordergoods(int id,String ordernumber,int cartserial,String receiver,String rphone,String address){
			//	插入订单数据到数据库
	...
	/*查询  某个用户id	的订单数据		*/
	public List<Ordergoods> find_Ordergoods(int id){
		Connection con = DataMySQL.getConnection();
