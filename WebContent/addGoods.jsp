										...
										<div id="dropzone">
											<form action="AddGoods" class="dropzone dz-clickable"
												...
												商品名称:<input type="text" class="form-control "
													name="goodsname"><br>店铺名称:<input type="text" class="form-control "
													name="shop"><br> 商品价格:<input type="text"
													class="form-control" name="price"><br>商品类别:<input type="text" class="form-control "
													name="category"><br> 商品数量:<input
													type="text" class="form-control" name="inventory"><br>
												<input type="hidden" class="form-control" name="usernumber"
												...
												<div class="input-append"> <td>请上传图片</td>
