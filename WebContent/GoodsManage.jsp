...
<body>
 ...
 超级管理员
						...
						<ul class="submenu">
							...
							<li><c:choose>
									<c:when test="${sessionScope.user.rowid  eq 1 }">
										<a href="deleteUser.jsp?rowid=1"> <i class="icon-double-angle-right"></i>
											${functionlist.get(2) }
					...
					<div class="page-header">
						<h1>
							${sessionScope.username } <small> <i
								class="icon-double-angle-right"></i>添加成功
							</small>
						</h1>
					</div>
					<!-- /.page-header -->
										...
										<div class="widget-box transparent">
											<div class="widget-header widget-header-small">
												<h4 class="blue smaller">
													<i class="icon-rss orange"></i> 所有宝贝
												</h4>
														...
														<c:forEach items="${list }" var="good" begin="1"
															...
															<div
																...
																<div style="font-size:15px;padding-top:4px">
																	...
																	&nbsp; <span>库存：${good.inventory }</span><span>
																	<a href="modifyGoods?number=${good.number }">修改</a>
																		</span> <span><a
																		href="LocateGoods.jsp?goodsid=${good.number }">删除</a></span>
																</div>
															</div>
