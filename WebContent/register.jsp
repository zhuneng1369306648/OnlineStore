            ...
            <div class="top-cart-contain">
              <div class="mini-cart">
                <div data-toggle="dropdown" data-hover="dropdown" class="basket dropdown-toggle"> <a href="#">
                  ...
                  <div class="shoppingcart-inner hidden-xs"><span class="cart-title">购物车</span> <span class="cart-total">0 Item(s): ￥0.00</span></div>
                  </a></div>               
              </div>
            </div>
          </div>     
    ...
    <div class="main container">
        ...
        <div class="page-content">
            ...
            <div class="account-login">
             ...
             <form action="RegisterServlet" id="form" name="form" method="post" accept-charset="UTF-8">
                ...
                <label for="passwords">密码<span class="required">*</span></label>
                <input id="password" name="password"  type="password" class="form-control">
                
                <label for="sex">性别（男/女）<span class="required">*</span></label>
                <input id="sex" type="text" name="sex" class="form-control">
                
                <label for="idcard">身份证号<span class="required">*</span></label>
                <input id="idcard" type="text"  name="idcard" class="form-control">
                
                <button class="button" type="submit" onclick="return check()"><span>注册</span></button>
                <br />
...
document.getElementById('img1'):function{
	
} */
document.getElementById('form').onsubmit=function(){
	//alert("123");
	var regm = /^[0-9]+[0-9]+[0-9]+$/
		//var a = /^[1-9]\d{5}[1-9]\d{3}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])\d{3}([0-9]|X)$/;
	if(!form.id.value.match(regm)|| form.id.value=="")
				{
		//layer.msg("ID为空或格式不正确！");
	...
	if(!form.idcard.value.match(a)||form.idcard.value=="")
	{
		alert("身份证号为空或格式不正确！");
		return false;
	}
