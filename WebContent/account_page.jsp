        ...
        <div class="page-content">
            <div class="account-login">
              ...
              <form action="FindUserServlet" name="form" method="post">
                ...
                <input id="login" placeholder="请输入用户名" type="text" name="id" class="form-control">
                <label for="password_login">密码<span class="required">*</span></label>
                <input id="password_login" placeholder="输入密码" name="password" type="password" class="form-control">
               <!--  <p class="forgot-pass"><a href="#">忘记密码?</a></p>
                 --><button class="button" type="submit" onclick="return check()"><span>登录</span></button>
                <button class="button" type="button" onclick="window.location.href='login.jsp'"><span>注册</span></button>
                <!--<button style="background: yellow; " type="button" name="submit" onclick="window.location.href=login.jsp"><span>注册</span></button>-->
