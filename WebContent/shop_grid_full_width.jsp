      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <ul>
            ...
            <li class=""> <a title="Go to Home Page" href="shop_grid.html">搜索结果</a><span>&raquo;</span></li>  
          </ul>
                ...
                <li class="item col-lg-3 col-md-4 col-sm-6 col-xs-6 ">
                  <div class="product-item">
                    <div class="item-inner">
                      <div class="product-thumbnail">
                        <div class="icon-sale-label sale-left">Sale</div>
                        <div class="pr-img-area"> <a title="${Agoods.goodsname}" href="${pageContext.request.contextPath}/Quick_viewServlet?param1=${Agoods.goodsname}">
                          <figure> <img class="first-img" src="${Agoods.img1}" alt=""> <img class="hover-img" src="${Agoods.img1}" alt=""></figure>
                          </a>
                         <button type="button" class="add-to-cart-mt" onclick="window.location.href='${pageContext.request.contextPath}/AddGoodsServlet?param1=${Agoods.number}&param2=1'"> <i class="fa fa-shopping-cart"></i><span>添加到购物车</span> </button>
                        </div>              
                      </div>
                      <div class="item-info">
                        <div class="info-inner">
                          <div class="item-title"> <a title="${Agoods.goodsname}" href="${pageContext.request.contextPath}/Single_productServlet?param1=${Agoods.goodsname}">${Agoods.goodsname}</a> </div>
                          <div class="item-content">
                            <div class="item-price">
                              <div class="price-box"> <span class="regular-price"> <span class="price">¥${Agoods.price}</span> </span> </div>
                              <div>销量：${Agoods.sales}</div>
                              <div>上架时间：${Agoods.date}</div>
                            </div>
                          </div>
                        </div>
                      </div>
