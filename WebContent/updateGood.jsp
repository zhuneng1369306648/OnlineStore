									...
									<div class="col-xs-12 col-sm-3 center">
										...
										<div class="profile-user-info profile-user-info-striped">
											<div class="profile-info-row">
												<div class="profile-info-name">店长</div>
											...
											<div class="profile-info-row">
												...
												<div class="profile-info-value">
													<i class="icon-map-marker light-orange bigger-110"></i> <span
														class="editable" id="country">成都市</span> <span
														class="editable" id="city">十陵</span>
												</div>
											</div>
													...
													<div id="dropzone">
														<form action="modifyGoods" class="dropzone dz-clickable"
															...
															商品名称:<input type="text" class="form-control "
																name="goodsname" value="${good.goodsname }"><br>
															店铺名称:<input type="text" class="form-control "
																name="shop" value="${good.shop }"><br>
															商品价格:<input type="text" class="form-control" name="price"
																value="${good.price }"><br>
															商品类别:<input type="text" class="form-control "
																name="category" value="${good.category }"><br>
															商品数量:<input type="text" class="form-control" name="inventory"
																value="${good.inventory }"><br> 
																<input
																type="hidden" class="form-control" name="number"
																value="${good.number }"><br>

															<div>
																<label for="form-field-8">店铺简介:</label>

																<textarea class="form-control" id="form-field-8"
																	placeholder="Default Text" style="height:200px;"
																	name="shopinfo">${good.shopinfo }</textarea>
															</div>
															<div>
																...
																<textarea class="form-control" id="form-field-8"
																	placeholder="Default Text" style="height:200px;"
																	name="contentinfo">${good.contentinfo }</textarea>
															</div>
															...
															<!-- <input id="lefile" type="file" style="display:none"
																name="file"> -->
																	...
																	value="${requestScope.good.img1 }">修改图片</a>-->
																	<img alt="150x150"
																	src="${good.img1 }" width="190px"
																	height="190px"><div class="input-append"> <td>请修改图片</td>
                 <td><input id="lefile" type="file" name="file" style="border: 0px; font-size: 20px;"/></td></div>
