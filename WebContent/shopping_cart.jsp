          ...
          <div class="page-content page-order"><div class="page-title">
            ...
            <div class="order-detail-content">
              <div class="table-responsive">
                ...
                <table class="table table-bordered cart_summary">
                  ...
                  <tbody>
                  	...
                  	<c:forEach var="Cart" items="${requestScope.Cart}"> 
                    <tr>
                      <td class="cart_product"><a href="${pageContext.request.contextPath}/Single_productServlet?param1=${Cart.goodsname}"><img src="${Cart.img1}" alt="Product"></a></td>
                      <td class="cart_description"><p class="product-name"><a href="${pageContext.request.contextPath}/Single_productServlet?param1=${Cart.goodsname}"><span id="goodsname">${Cart.goodsname}</span></a></p>
                      ...
                      <td class="action"><a href="${pageContext.request.contextPath}/DeleteGoodsServlet?param1=${Cart.cartserial}"><i class="icon-close"></i></a></td>
                  ...
                  <tfoot>
                    ...
                    <tr>
                      ...
                      <td colspan="1"><button type="submit" class="checkout-btn" onclick="return check()"><i class="fa fa-check"></i>结算</button></td>   
                    </tr>
             ...
             <!--  <div class="cart_navigation"> 
              	<a class="continue-btn" href="FindGoodsServlet"><i class="fa fa-arrow-left"> </i>&nbsp; 继续购物</a> 
...
document.getElementById('qty').onblur=function(){
	...
	alert(inventory); */
	 ...
	 var goodsname = document.getElementById("goodsname").innerText; 
	 document.getElementById("tprice").innerHTML = "￥"+ qty*price;
	 window.location.href="UpdateCartServlet?param1="+goodsname+"&param2="+qty+"";
	} 
 }
