				...
				<div class="col-sm-10 col-sm-offset-1">
					<div class="login-container">
						<div class="center">
							...
							<h1>
								<i class="icon-leaf green"></i> <span class="white">登录</span>
							</h1>
							<h4 class="blue">校园网上自助购物系统</h4>
							<h4><a href="index.jsp" 
											class="back-to-login-link"> 返回商店 <i class="icon-arrow-left"></i> 
										</a>
										</h4>
											...
											<fieldset>
												...
												<!-- </label> <label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														...
														name="id" id="id" /> <i class="icon-lock"></i>
												</span> -->
												</label> <label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
