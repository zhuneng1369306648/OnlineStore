					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form action="FindGoodByName" method="get">
								...
								<input type="hidden" class="form-control search-query col-lg-4" name="goodsname" >
                        	...
                        	<table class="table table-striped" align="left"
								...
								<tr class="container-flow"
									...
									<td class="col-lg-2"> ${good.inventory }</td>	
								    <td class="col-lg-2"> ${good.price }</td>	
								    <td class="col-lg-2">${good.users.username  }</td>
					
									<td class="col-lg-2"><a href="DeleteGoods?goodsid=${good.number}"
